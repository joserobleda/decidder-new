(function(b,f){var d=$("#canvas"),a=$("form#question"),c=window.__userid||false;var e=function(h){h.preventDefault();var g=["#responses","#context","#doubts","#question h1","#pendingDoubts"];
...
i.on("connect",function(){i.emit("join",g);});i.on("change",function(m){if(j==true&&m.collection=="questions"){return;}if(c===m.user&&m.collection!="doubt"){return;
}l.slideDown();});i.on("viewers",function(m){if(h!=m){h=m;k.html(m);}});});}$(document).bindCustomEvents();})(window);